...
Each repository demonstrates real analyst tasks:
alert investigation, evidence collection, escalation decisions, and documentation.

---

## 🔐 SOC Work Demonstrated Here

- SIEM alert triage and investigation
- Log analysis across endpoint, network, and server data
- Phishing, malware, and ransomware analysis
- Incident escalation with documented evidence
- Creation of detection logic and response playbooks
- Automation of repetitive SOC tasks using scripting

---

## 📊 Hands-On SOC & Security Projects

Each project includes investigation steps, evidence, and analyst decision-making.

| Project                                | Skills Demonstrated                                                                              | Repository                                                                                                           |
| -------------------------------------- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| **SIEM & IDS Detection Lab**           | Event correlation · Security monitoring · Dashboard reporting                                    | [Link](https://github.com/Andy-Hutch/Andy-Hutch/tree/main/7%20-%20IDS%20%26%20SIEM)                                  | 
| **Detection & Incident Response**      | Incident response planning · Audit trail creation · Reporting insights                           | [Link](https://github.com/Andy-Hutch/Andy-Hutch/tree/main/5%20-%20Detection%20%26%20response)                        |
...
| **SOC Automation with Python**         | SOC workflow · Log parsing · Report generation                                                   | [Link](https://github.com/Andy-Hutch/Andy-Hutch/tree/main/8%20-%20Automation%20with%20Python)                        |
| **SOC Analyst Notes Repository**       | Comprehensive notes · labs · hands-on SOC exercises from TryHackMe and other SOC L1 sumulations  | [Link](https://github.com/Andy-Hutch/soc-analyst-notes)                                                              |
